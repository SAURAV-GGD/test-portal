...
- [client/src/api.js](/Users/arushisingh/Desktop/untitled folder/client/src/api.js) lines `1-12`, `129-133`
- [server/routes/faqs.js](/Users/arushisingh/Desktop/untitled folder/server/routes/faqs.js) lines `6-74`
- [server/index.js](/Users/arushisingh/Desktop/untitled folder/server/index.js) lines `299-310`

## What Changed

- Added safe JSON parsing in the shared API helper so FAQ fetches do not explode on empty response bodies.
- Updated the FAQ route to merge the original FAQ corpus from [`server/data.js`](/Users/arushisingh/Desktop/untitled folder/server/data.js) with database records and filter the merged dataset by category/search.
